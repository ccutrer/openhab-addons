 ...
 */
public class HomekitSmartSpeakerImpl extends AbstractHomekitAccessoryImpl {
    ...
    public void init() throws HomekitException {
        super.init();
        addService(new SmartSpeakerService(getCharacteristic(CurrentMediaStateCharacteristic.class).get(),
                getCharacteristic(TargetMediaStateCharacteristic.class).get()));
    }
}
