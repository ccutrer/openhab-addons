 ...
 *
 */
public class HomekitLockImpl extends AbstractHomekitAccessoryImpl {
    ...
    public void init() throws HomekitException {
        super.init();
        addService(new LockMechanismService(getCharacteristic(LockCurrentStateCharacteristic.class).get(),
                getCharacteristic(LockTargetStateCharacteristic.class).get()));
    }
}
