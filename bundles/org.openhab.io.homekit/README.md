...
|                      | AirQuality                  |                              | String                        | Air quality state, possible values (UNKNOWN,EXCELLENT,GOOD,FAIR,INFERIOR,POOR). Custom mapping can be defined at item level, e.g. [EXCELLENT="BEST", POOR="BAD"]. Can also be configured via metadata, e.g. [AirQuality="UNKNOWN"].                                                                                                                 |
...
|                      | CurrentHeatingCoolingMode   |                              | String                        | Current heating cooling mode (OFF, HEAT, COOL). for mapping see homekit settings above. Can also be configured via metadata, e.g. [CurrentHeatingCoolingState="HEAT"].                                                                                                                                                                              |
|                      | TargetHeatingCoolingMode    |                              | String                        | Target heating cooling mode (OFF, AUTO, HEAT, COOL). for mapping see homekit settings above. Can also be configured via metadata, e.g. [TargetHeatingCoolingState="HEAT"].                                                                                                                                                                          |
...
|                      | ActiveStatus                |                              | Switch, Dimmer                | Accessory current working status. A value of "ON"/"OPEN" indicates that the accessory is active and is functioning without any errors.                                                                                                                                                                                                              |
|                      | CurrentTemperature          |                              | Number                        | Current temperature. supported configuration: minValue, maxValue, step                                                                                                                                                                                                                                                                              |
|                      | CurrentHeaterCoolerState    |                              | String                        | Current heater/cooler mode (INACTIVE, IDLE, HEATING, COOLING). Mapping can be redefined at item level, e.g. [HEATING="HEAT", COOLING="COOL"]. Can also be configured via metadata, e.g. [CurrentHeaterCoolerMode="HEATING"].                                                                                                                        |
|                      | TargetHeaterCoolerState     |                              | String                        | Target heater/cooler mode (AUTO, HEAT, COOL). Mapping can be redefined at item level, e.g. [AUTO="AUTOMATIC"]. Can also be configured via metadata, e.g. [TargetHeaterCoolerState="HEAT"].                                                                                                                                                          |
