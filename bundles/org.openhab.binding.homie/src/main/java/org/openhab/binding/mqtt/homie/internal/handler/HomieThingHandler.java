...
public class HomieThingHandler extends AbstractMQTTThingHandler implements DeviceCallback, Consumer<List<Object>> {
    ...
    private void updateThingType() {
        ...
        if (!HomieBindingConstants.HOMIE_DEVICE_THING.equals(typeID)
                && !HomieBindingConstants.LEGACY_MQTT_HOMIE300_THING.equals(typeID)) {
            ...
            var builder = channelTypeProvider.derive(typeID, HomieBindingConstants.HOMIE_DEVICE_THING)
