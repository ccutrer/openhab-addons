 ...
 */
package org.openhab.binding.homie.internal.discovery;
...
public class Homie500Discovery extends AbstractMQTTDiscovery {
    ...
    public Homie500Discovery(@Reference MQTTTopicDiscoveryService discoveryService) {
        super(Set.of(HomieBindingConstants.HOMIE_DEVICE_THING), 3, true, "+/5/+/$state");
    ...
    void publishDevice(ThingUID connectionBridge, MqttBrokerConnection connection, String deviceID, String topic,
        ...
        thingDiscovered(DiscoveryResultBuilder
                .create(new ThingUID(HomieBindingConstants.HOMIE_DEVICE_THING, connectionBridge, deviceID))
    ...
    public void topicVanished(ThingUID connectionBridge, MqttBrokerConnection connection, String topic) {
        ...
        thingRemoved(new ThingUID(HomieBindingConstants.HOMIE_DEVICE_THING, connectionBridge, deviceID));
    }
}
