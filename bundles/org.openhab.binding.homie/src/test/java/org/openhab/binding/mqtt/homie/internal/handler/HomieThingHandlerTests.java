 ...
 */
package org.openhab.binding.homie.internal.handler;
...
import static org.openhab.binding.homie.internal.handler.ThingChannelConstants.TEST_HOMIE_THING;
...
import org.openhab.binding.homie.ChannelStateHelper;
import org.openhab.binding.homie.ThingHandlerHelper;
...
import org.openhab.binding.homie.internal.homie.PropertyAttributes;
...
public class HomieThingHandlerTests {
    ...
    public void setUp() {
        ...
        ThingTypeUID type = new ThingTypeUID(HomieBindingConstants.BINDING_ID,
                HomieBindingConstants.HOMIE_DEVICE_THING.getId() + "_dynamic");
    ...
    public void propertiesChanged() throws InterruptedException, ExecutionException {
        ...
        assertThat(properties.get(HomieBindingConstants.HOMIE_PROPERTY_VERSION), is("3.0"));
